...
DATASETS = {
    'hi2d_val': {
        IM_DIR:
            _DATA_DIR + '/data/datasets_home/datasets/Honda_Intersection_Dataset/frames',
        ANN_FN:
            _DATA_DIR + '/home/ataha/code_backup/Detectron.pytorch/hi2d_val_featureextraction.json',
    },
